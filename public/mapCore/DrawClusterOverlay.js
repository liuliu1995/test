 ...
 * 主入口类是<a href="symbols/BMapLib.DrawCluster.html">DrawCluster</a>，
 * 基于Baidu Map API 1.2。
 *
...
(function () {
     ...
     */
    var _IMAGE_PATH = window.TextIconOverlayUrl+'api.map.baidu.com/library/TextIconOverlay/1.2/src/images/m';
    ...
    /**
     *@exports DrawCluster as BMapLib.DrawCluster
     */
    var DrawCluster =
        /**
         * DrawCluster
         ...
         */
        BMapLib.DrawCluster = function(position,text, options){
            this._position = position;
            this._text = text;
            this._options = options || {};
            this._clickFun = options.clickFun;
            this._styles = this._options['styles'] || [];
            (!this._styles.length) && this._setupDefaultStyles();
        };

    T.lang.inherits(DrawCluster, BMap.Overlay, "DrawCluster");

    DrawCluster.prototype._setupDefaultStyles = function(){
     ...
     */
    DrawCluster.prototype.initialize = function(map){
        this._map = map;
     ...
     *@return 无返回值。
     */
    DrawCluster.prototype.draw = function(){
     ...
     */
    DrawCluster.prototype.getText = function(){
        return this._text;
    };
     ...
     *@return 无返回值。
     */
    DrawCluster.prototype.setText = function(text){
     ...
     */
    DrawCluster.prototype.getPosition = function () {
     ...
     *@return 无返回值。
     */
    DrawCluster.prototype.setPosition = function (position) {
     ...
     */
    DrawCluster.prototype.getStyleByText = function(text, styles){
        var count = parseInt(text);
        var numStr = parseInt(count / 10) +"";
        var index = 0;
        if(numStr != "0") {
            index = numStr.length;
            if(index > 5) {
     ...
     *@return 无返回值。
     */
    DrawCluster.prototype._updateCss = function(){
     ...
     *@return 无返回值。
     */
    DrawCluster.prototype._updateText = function(){
        if (this._domElement) {
     ...
     *@return 无返回值。
     */
    DrawCluster.prototype._updatePosition = function(){
        if (this._domElement && this._position) {
            this._domElement.id=this._position.lng+","+this._position.lat;
     ...
     */
    DrawCluster.prototype._buildCssText = function(style) {
        //根据style来确定一些默认值
        var _drawtype = style['drawtype'];
        var url = style['url'];
        var size = style['size'];
        ...
        var backgroundColor = style['backgroundColor'] || 'rgba(255, 152, 0, 0.42)';
        var _border = style['border'] || '1px solid #FF9800';
     ...
     * <br />"<b>target</b>：{BMapLib.DrawCluster} 事件目标
     *
     */
        DrawCluster.prototype.showClusterMarkers = function(){
            var ele = document.getElementById(this._position.lng+","+this._position.lat);
            ele.addEventListener('click',this._clickFun);
            ele.addEventListener('touchstart',this._clickFun);
        };
    /**

     * 当鼠标进入该覆盖物区域时会触发该事件

     * @name DrawCluster#mouseover
     ...
     * myDrawCluster.addEventListener("mouseover", function(e) {  alert(e.point);  });
     ...
     * myDrawCluster.addEventListener("mouseout", function(e) {  alert(e.point);  });
     ...
     * @return 无返回值。
     */
    DrawCluster.prototype._bind = function(){
        if (!this._domElement){
            return;
        }
